...
List names = ["Umair Arshad","Umar ","Abu Bakar","Madoodi"]
names.each { name ->
    println name
}
...
List people = [
    [name:'Umair',city:"New York City"],
    [name:'Umar',city:"Cleveland"],
    [name:'Irfan',city:"New York City"],
    [name:'Said',city:"Cleveland"],
    [name:'Safwan',city:"New York City"],
    [name:'Adeel',city:"New York City"],
    [name:'Hassan',city:"Cleveland"]    
]
